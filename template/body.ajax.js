...
if (!top.htmltag.ajax) {
	...
	getdbentry_func : function (onextID,fileid,elemid,rep) {
	...
	replaceAJAXpath : function (fileid,xmlid,id,finish,arg) {
	    var onextID = nextID++;
	...
	replaceAJAXspan : function (elem,fileid,xmlid) {
	...
	replaceAJAXdiv : function (elem,fileid,xmlid) {
	    var onextID = nextID++;
	...
	replaceAJAXelem : function (tag,elem,fileid,xmlid) {
	    var onextID = nextID++;
	...
	showajaxtool : function (thisid, args) {
	    var onextID = nextID;
